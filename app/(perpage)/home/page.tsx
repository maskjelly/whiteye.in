  ...
  useEffect(() => {
    ...
    targetChars.forEach((targetChar, index) => {
      ...
      const animateChar = () => {
        ...
        const frameId = window.setTimeout(animateChar, 20 + Math.random() * 30);
        ...
        <div className="space-y-6 md:space-y-8">
          ...
          <div>
            <p className="leading-relaxed text-sm sm:text-base">
              ...
              solving problems. i enjoy language design, practical computer
              science, and i live on the terminal. if i'm not coding, i'm
              probably doing cardio, watching movies, or obsessing over
              mechanical keyboards and robots.
            </p>
          </div>
            ...
            <div className="space-y-6 md:space-y-8">
              <div>
                <h3 className="text-white font-bold">
                  Rice University Security Audit
                </h3>
                <p className="text-xs sm:text-sm text-gray-400">
                  Bounty Hacker
                </p>
                <p className="text-sm sm:text-base">
                  Engineered (under bounty) hack against rice.edu's systems and
                  gained access to every inch of their database | reported and
                  audited their website for for further security access and
                  flaws
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-400">
                  O1Visa & StealthStartup
                </p>
                <p className="text-sm sm:text-base">
                  Built directory and worked on re-designing backend for scale.
                  Worked on NextFaster making AGENTIC directories for onboarding
                  new users
                </p>
                <br />
                <p className="text-sm sm:text-base">
                  Built in-house email ranking engine tagging mails with AI and
                  lifetime context for LLM's with MEM0 and custom vector updates
                  per clients - Redis for client performance.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm sm:text-base">
                  Worked with 22+ clients building or maintaining theere MVP and
                  business ports.
                </p>
              </div>
            </div>
